...
def camera_feeds():
    return [
        CameraFeed("Демо-видео", "Кабинет 5", "запись урока", "Запись", "1920x1080", 83, 4, True, True, "demo_video"),
        CameraFeed("EZVIZ C1C-B", "IP камера", "реальная камера", "RTSP", "1920x1080", 0, 0, True, True, "ip_camera"),
        CameraFeed("Камера 301-А", "Кабинет 301", "фронтальная", "Нет потока", "1920x1080", 0, 0, False, False, "closed"),
        CameraFeed("Камера 301-B", "Кабинет 301", "задняя", "Нет потока", "1920x1080", 0, 0, False, False, "closed"),
        CameraFeed("Камера 302-А", "Кабинет 302", "широкоугольная", "Нет потока", "2560x1440", 0, 0, False, False, "closed"),
        CameraFeed("Камера 204-А", "Кабинет 204", "фронтальная", "Нет потока", "1920x1080", 0, 0, False, False, "closed"),
        CameraFeed("Камера 204-B", "Кабинет 204", "задняя", "Нет потока", "1920x1080", 0, 0, False, False, "closed"),
        CameraFeed("Камера 310-А", "Кабинет 310", "широкоугольная", "Нет потока", "2560x1440", 0, 0, False, False, "closed"),
    ]
